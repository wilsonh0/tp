...
public class CommandTestUtil {
    ...
    public static final String VALID_HIRE_AMY = "2025-01-01";
    public static final String VALID_HIRE_BOB = "2025-01-02";
    ...
    public static final String INVALID_NRIC_DESC = " " + PREFIX_NRIC + "T0000001&"; // '&' not allowed in nrics
    public static final String INVALID_PHONE_DESC = " " + PREFIX_PHONE + "911a"; // 'a' not allowed in phones
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_EMAIL + "bob!yahoo"; // missing '@' symbol
    public static final String INVALID_ADDRESS_DESC = " " + PREFIX_ADDRESS; // empty string not allowed for addresses
    public static final String INVALID_HIRE_DESC = " " + PREFIX_HIRE + "a"; // 'a' not allowed for hire
